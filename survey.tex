...
that we will adopt, outlining two general paradigms:
...
the ranked list.  Thus, in addition IR-style measures may be also used.
...
\hline
System & Prec@1 & APrec. & ARecall & F1 (Berant) & F1 (Yao) & MRR & MAP \\ \hline
