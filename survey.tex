...
list of answers, and
\cite{Fader2013Paraphrase} defines \textit{precision} as the proportion of returned answers that are true,
while \textit{recall} would be the proportion of questions that are correctly answered;
however,
\cite{TreeFreebase2014Yao} defines \textit{recall} more naturally
