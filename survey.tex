...
answered questions,%
\footnote{Except some outliers; \cite{Ephyra2006} uses precision to denote number
	of questions where at least one of the suggested answers
	is correct --- something we call Answer Production Recall later.}
